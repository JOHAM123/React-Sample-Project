        ...
        <div className="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
          <div className="page-header">
            ...
            <p className="pageheader-text">
              Lorem ipsum dolor sit ametllam fermentum ipsum eu porta
              consectetur adipiscing elit.Nullam vehicula nulla ut egestas
              rhoncus.
            </p>
          ...
          <div className="card">
            ...
            <div className="card-body border-top">
              <div className="row">
                ...
                <div className="col-xl-6">
                  <div className="sell-ratio">
                    <h5 className="mb-1 mt-0 font-weight-normal">
                      San Francisco
                    </h5>
                    <div className="progress-w-percent">
